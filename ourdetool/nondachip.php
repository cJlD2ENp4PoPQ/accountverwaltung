...
//nur die accounts die in den letzten 30 tagen aktiv waren
$tis=time()-86400*30;
$last_login=date("Y-m-d H:i:s",$tis);

$db_daten=mysql_query("SELECT * FROM ls_user WHERE last_ip<>'127.0.0.1' AND last_ip<>'' AND last_login>'$last_login' ORDER BY last_ip ASC",$db);
